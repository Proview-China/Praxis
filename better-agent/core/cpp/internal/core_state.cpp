...
std::unordered_map<std::string, RunningExecution> g_running_executions;
json g_sandbox_capability_cache = json::object();
bool g_sandbox_capability_cache_valid = false;
